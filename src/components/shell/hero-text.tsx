...
export function HeroText() {
  ...
  return (
    <div>
      ...
      <h1 className="font-display text-display-xl leading-[0.96] tracking-[-0.02em] text-ink">
        {[
          { t: "La beauté" },
          ...
          <span key={l.t} className="block overflow-hidden pb-[0.06em]">
            <motion.span
              ...
              className={`block ${l.accent ? "text-vert" : ""} ${l.i ? "italic" : ""}`}
      ...
      <motion.p
        ...
        className="mt-8 max-w-lg text-[15px] leading-[1.8] text-pretty text-muted sm:text-base"
      >
